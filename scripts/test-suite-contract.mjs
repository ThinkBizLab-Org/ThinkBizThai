...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 46,
  'test-kits/db/rls-assertions.test.mjs': 20,
  'tests/db/identity/identity-isolation.test.mjs': 162,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 171,
  'test-kits/db/rls-assertions.test.mjs': 108,
  'tests/db/identity/identity-isolation.test.mjs': 1162,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  'test-kits/db/foundation-contract.test.mjs': 'f6f13367aaddd14e',
  'test-kits/db/rls-assertions.test.mjs': '04e93ef6577ba5ce',
  'tests/db/identity/identity-isolation.test.mjs': '7191b1d4558aecd3',
