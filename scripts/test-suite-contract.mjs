...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 19,
  'test-kits/db/rls-assertions.test.mjs': 16,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 74,
  'test-kits/db/rls-assertions.test.mjs': 74,
