...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 14,
  ...
  'test-kits/handoff-conformance.test.mjs': 12,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 40,
  ...
  'test-kits/handoff-conformance.test.mjs': 21,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  'test-kits/db/foundation-contract.test.mjs': '697671fff9d16229',
  ...
  'test-kits/handoff-conformance.test.mjs': '6c0d90ffe79fdbb6',
