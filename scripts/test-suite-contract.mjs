...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 79,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 511,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 'a82314569c219002',
