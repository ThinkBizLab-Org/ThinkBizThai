...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 81,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 564,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': '4f5ebe709ad3985a',
