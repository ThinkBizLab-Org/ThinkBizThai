...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 47,
  'test-kits/db/rls-assertions.test.mjs': 20,
  'tests/db/identity/identity-isolation.test.mjs': 179,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 175,
  'test-kits/db/rls-assertions.test.mjs': 108,
  'tests/db/identity/identity-isolation.test.mjs': 1316,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  'test-kits/db/foundation-contract.test.mjs': 'd23d07cba06933f2',
  'test-kits/db/rls-assertions.test.mjs': '04e93ef6577ba5ce',
  'tests/db/identity/identity-isolation.test.mjs': 'c8c0516a8453d32d',
