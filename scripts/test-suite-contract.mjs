...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 66,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'test-kits/db/rls-assertions.test.mjs': 106,
  'tests/db/identity/identity-isolation.test.mjs': 445,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 'c740629c89b7d23c',
