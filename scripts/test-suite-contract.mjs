...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 78,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 520,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': '5df5b44c7be75a96',
