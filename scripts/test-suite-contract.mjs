...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 103,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 693,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 'dd95ffb998df77a9',
