...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'test-kits/db/foundation-contract.test.mjs': 42,
  'test-kits/db/rls-assertions.test.mjs': 20,
  'tests/db/identity/identity-isolation.test.mjs': 28,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 139,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': '78c5f938e38a0529',
