...
export const DECLARED_TEST_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 65,
...
export const DECLARED_ASSERTION_FLOOR_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 437,
...
export const TEST_NAME_DIGEST_BY_FILE = {
  ...
  'tests/db/identity/identity-isolation.test.mjs': 'c82289932a929fa5',
