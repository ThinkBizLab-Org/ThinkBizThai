...
const BRANCH_OWNERSHIP = {
  ...
  'agent/claude/WP-0A-CON-008-concurrent-sweep': 'WP-0A-CON-008',
  ...
  'agent/claude/WP-0A-DB-00-service-path-negatives': 'WP-0A-DB-00',
