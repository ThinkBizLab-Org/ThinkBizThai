...
const BRANCH_OWNERSHIP = {
  ...
  'agent/claude/WP-0A-CON-008-pid-reuse-age-floor': 'WP-0A-CON-008',
  ...
  'agent/claude/WP-0A-DB-00-batch-041': 'WP-0A-DB-00',
