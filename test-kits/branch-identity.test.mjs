...
test('every branch in this repository resolves to exactly one package', async () => {
  ...
  for (const ref of [
    ...
    'agent/claude/WP-0A-DB-00-session-2026-09-15-second-pass-close',
...
const BRANCH_OWNERSHIP = {
  ...
  'agent/claude/WP-0A-A0-007-amend-section-2': 'WP-0A-A0-007',
  'agent/claude/WP-0A-A0-006-db00-data-decisions': 'WP-0A-A0-006',
  'agent/claude/WP-0A-DB-00-session-2026-09-15-second-pass-close': 'WP-0A-DB-00',
